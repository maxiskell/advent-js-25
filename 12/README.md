...
- `A` _Normal attack_: deals 1 point of damage if it’s not blocked
- `B` _Block_: blocks a normal attack (`A`)
- `F` _Strong attack_: deals 2 points of damage, cannot be blocked
